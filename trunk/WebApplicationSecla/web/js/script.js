...
function validarModificarReciboInspector(){
    ...
    if(numeroacta==0){
        ...
        numeroacta = document.form1.numeroacta.value;
        if((/^[0-9]*$/.test(numeroacta))){
            document.getElementById('nacta').style.visibility = 'hidden';
        }else{
            document.getElementById('nacta').innerHTML = "Debe ser un numero";
            document.getElementById('nacta').style.visibility = 'visible';
            aux++;
        }
    }
