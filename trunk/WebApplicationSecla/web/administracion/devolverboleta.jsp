...
<%
	...
	if(operador != null){
		...
		resultado = manager.devolverRecibos(operador,numMin,numMax);
		if(resultado != null){
			if(resultado == "true"){
...
<%@ include file="left.jsp" %>
  ...
  &nbsp;al &nbsp;
                    ...
                    <tr height="50px">
                    	<td align="center"><input name="entregar" type="button" value="Devolver" onClick="validarEntregarRecibo()" /></td>
                  </tr>
                </table>
              </td>
            </tr>
