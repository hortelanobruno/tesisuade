...
<%@ include file="left.jsp" %>
    ...
    <td width="595" colspan="4" valign="top">	<p>&nbsp;</p>
      <table border="0" cellspacing="0" cellpadding="0" width="595">
        <tr>
          <td class="pageName"><h1>Cargar boleta</h1></td>
		</tr>
		...
		<tr>
          ...
          <li><h3>&nbsp;&nbsp;&nbsp;<a href="boletaaanular.jsp" class="navText2">Anular boleta</a></h3></li>
          <li><h3>&nbsp;&nbsp;&nbsp;<a href="boletaextraviada.jsp" class="navText2">Extravio de boleta</a></h3></li>
          </ul>
          </td>
          </tr>
          </table>
