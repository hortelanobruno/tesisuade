    ...
    <body>
        ...
        for (int i = 0; i < recibos.size(); i++) {
            out.print("<option value=" + recibos.get(i) + ">" + recibos.get(i) + "</option>");
                                            ...
                                            <tr>
                                                <td>Numero acta</td>
                                                <td><input name="numeroacta" type="text" size="30" /><br><label class="error" id="nacta" style="visibility:hidden"></label></td>
                                            </tr>
                                            <tr>
                                                <td colspan="3" align="center" bgcolor="#4D6FAC">
                                            ...
                                            <tr >
                                                <td height="30px" colspan="2" align="center">
                                                    <input name="cargar" type="button" value="Cargar recibo" style="width:100px" onClick="validarCompletarReciboInspector()"/>
                                                </td>
                                            </tr>
                                    </table></td>
                                </tr>
