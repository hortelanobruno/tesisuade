		...
		<tr>
          ...
          <form method="post" target="_parent" action="cambiarpassword.jsp" name="form1" >
			 <table width="100%" cellpadding="1" cellspacing="5">
              <tr>
                <td><input name="password4" type="hidden" size="30" value="<%=datos.get(0)%>"/>&nbsp;</td>
                <td width="20px">&nbsp;</td>
                <td>&nbsp;</td>
          	  </tr>
              <tr >
              ...
              <tr>
                ...
                <td>&nbsp;</td>
                <td><input name="password1" type="password" size="30" />&nbsp;&nbsp;&nbsp;&nbsp;<label class="error" id="pwd1" style="visibility:hidden">Debe completar el campo</label>
                <label class="error" id="pwds2" style="visibility:hidden">Password actual incorrecto</label>
                </td>
              </tr>
              <tr>
                <td>Contrase&ntilde;a nueva</td>
                <td>&nbsp;</td>
                <td><input name="password2" type="password" size="30" />&nbsp;&nbsp;&nbsp;&nbsp;<label class="error" id="pwd2" style="visibility:hidden">Debe completar el campo</label>
                </td>
              </tr>
              <tr>
                <td>Repetir contrase&ntilde;a nueva</td>
                <td>&nbsp;</td>
                <td><input name="password3" type="password" size="30" />&nbsp;&nbsp;&nbsp;&nbsp;<label class="error" id="pwd3" style="visibility:hidden">Debe completar el campo</label>
                </td>
              </tr>
              <tr >
