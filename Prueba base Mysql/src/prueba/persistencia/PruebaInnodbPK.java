 ...
 */
@Embeddable
public class PruebaInnodbPK implements Serializable {
    ...
    public PruebaInnodbPK() {
    }

    public PruebaInnodbPK(long timestamp, String cMmacAddress) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PruebaInnodbPK)) {
            return false;
        }
        PruebaInnodbPK other = (PruebaInnodbPK) object;
    ...
    public String toString() {
        return "prueba.persistencia.PruebaInnodbPK[timestamp=" + timestamp + ", cMmacAddress=" + cMmacAddress + "]";
    }
