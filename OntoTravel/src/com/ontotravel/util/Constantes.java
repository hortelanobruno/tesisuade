...
public class Constantes 
{
    ...
    public static final String ICONINHERITEDOBJECTPROPERTY = "./icons/OWLObjectPropertyInherited.GIF";
    public static final String ICONINDIVIDUAL = "./icons/OWLIndividual.gif";
    public static final String ICONTREE = "./icons/TreeBold2.gif";
    public static final String CONFIGURATION_URL = "./config/conf.xml";
}
